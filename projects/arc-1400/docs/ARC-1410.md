...
- `arc1410_balance_of_partition(holder: address, partition: address) -> (amount: uint64)`
...
- `arc1410_issue_by_partition(to: address, partition: address, amount: uint64, data: bytes)`
- `arc1410_redeem_by_partition(from: address, partition: address, amount: uint64, data: bytes)`
