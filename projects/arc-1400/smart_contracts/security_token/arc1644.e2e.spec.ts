...
import { Arc1644Factory } from '../artifacts/security_token/Arc1644Client'
...
describe('Arc1644 controller', () => {
  ...
  const deploy = async (account: Address) => {
    ...
    const factory = localnet.algorand.client.getTypedAppFactory(Arc1644Factory, { defaultSender: account })
